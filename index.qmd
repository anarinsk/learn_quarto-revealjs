...
This is testflight for personal use. In this slide, I will test some (nice) features of reveal.js for my person use. The features come mostly from [Quarto-Revealjs](https://quarto.org/docs/presentations/revealjs/).
<br>
<br>
