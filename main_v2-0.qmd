...
## 꽉찬 벽지 II {
  background-color="black" 
  background-image="https://mediaproxy.tvtropes.org/width/350/https://static.tvtropes.org/pmwiki/pub/images/amazing_spider_man_vol_2_50_textless.png" background-size="contain" 
  background-opacity="0.5" }
...
## 슬라이드 형태는 유지하고 가운데 정렬{.smaller}

:::{layout="[[-0.5],[-1,1,-1],[-0.5]]"}
