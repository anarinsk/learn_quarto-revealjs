...
- 슬라이드에서 생성 코드를 상세하게 해설하지 않습니다. [소스](https://github.com/anarinsk/learn_quarto-revealjs/blob/main/main_v2-0.qmd)와 함께 보시면 구현 방법을 이해하실 수 있습니다.  
:::
...
단 이렇게 걸면, 제목 등등도 모두 css의 적용을 받게 된다. 
:::
...
{{< video https://www.youtube.com/watch?v=zWaymcVmJ-A 
  width="90%" height="90%" >}}
...
## { data-menu-title="Github Publish (cont'd)" }
...
:::{ .nonincremental }
- 그림의 크기와 위치는 `(...)` 내부 대신에 `layout="(...)"`으로 하는 것이 편리하다. 
